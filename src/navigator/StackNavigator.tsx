...
export const StackNavigator = () => {
    return (
        <Stack.Navigator
            //initialRouteName="Pagina2Screen" definir screen por la que empieza la app
            screenOptions={{
                headerStyle: {
                    elevation: 0, // quitar línea en android
                    shadowColor: 'transparent' // quitar línea en iphone
                },
                cardStyle: {
